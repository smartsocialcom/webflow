        ...
        testimonials += `
          <div class="testimonial_card">
            ...
            <div>
              ...
              <p class="created_at"><span data-ms-content="master-admin">${date}</span></p>
            </div>
          </div>`;
      });
        ...
        document.getElementById("other_feedbacks_list").innerHTML = data.map(({ positive_feedback, page_name, created_at, organization_info }) => `
          <div class="testimonial_card">
            ...
            <div>
              ...
              <p class="created_at"><span data-ms-content="master-admin">${new Date(created_at).toLocaleDateString("en-US", { year: "numeric", month: "2-digit", day: "2-digit" })}</span></p>
            </div>
          </div>`).join("");
      });
